...
def good_vs_evil(good, evil)
  ...
  good.split(" ").each_with_index {|v,i| gsum += g[i] * v.to_i}
  evil.split(" ").each_with_index {|v,i| esum += e[i] * v.to_i}

  if gsum == esum
    "Battle Result: No victor on this battle field"
  else
    gsum > esum ? "Battle Result: Good triumphs over Evil" : "Battle Result: Evil eradicates all trace of Good"
  end
end